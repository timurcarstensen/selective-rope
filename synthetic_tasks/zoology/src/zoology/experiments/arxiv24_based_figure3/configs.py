...
train_configs = [
    ...
    MQARConfig(
        vocab_size=VOCAB_SIZE, input_seq_len=256, num_examples=20_000, num_kv_pairs=64
    ),
]
test_configs = [
    MQARConfig(
...
for d_model in [64, 128, 192, 256, 320, 384, 448, 512]:
    ftrs = []
    ...
    for ftr_dim in [16, 24]:
        ftrs.append(
            {
                "feature_name": "zoology.mixers.feature_maps.taylor.TaylorExp",
                "feature_dim": ftr_dim,
            }
        )
    ...
    ftrs.extend(
        [
            ...
            {
                "feature_name": "zoology.mixers.feature_maps.base.ReLU",
                "feature_dim": d_model,
            },
            {
                "feature_name": "zoology.mixers.feature_maps.base.Square",
                "feature_dim": d_model,
            },
            {
                "feature_name": "zoology.mixers.feature_maps.cosformer.CosFormerFeatureMap",
                "feature_dim": d_model,
            },
            {
                "feature_name": "zoology.mixers.feature_maps.performer.PerformerFeatureMap",
                "feature_dim": d_model,
            },
        ]
    )
