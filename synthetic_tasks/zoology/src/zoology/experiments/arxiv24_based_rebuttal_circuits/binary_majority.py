...
for k in [1, 2, 4, 8, 16, 24, 32, 64]:
    train_configs.append(
        MajorityConfig(vocab_size=VOCAB_SIZE, input_seq_len=k, num_examples=100_000)
    )
    test_configs.append(
        MajorityConfig(vocab_size=VOCAB_SIZE, input_seq_len=k, num_examples=1_000)
    )
