...
from .ops.vandermonde import log_vandermonde_fast
from .ssm_utils import OptimModule

try:
    import pykeops

    from .ops.vandermonde import log_vandermonde, log_vandermonde_transpose

    has_pykeops = True
except ImportError:
    has_pykeops = False
    from .ops.vandermonde import log_vandermonde_naive as log_vandermonde
    from .ops.vandermonde import (
