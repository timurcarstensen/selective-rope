...
from zoology.mixers.mamba_ssm.triton.layernorm import (
    RMSNorm,
    layer_norm_fn,
)
...
try:
    ...
    assert 0, print("Need to install causal_conv1d: pip install causal_conv1d")
from zoology.mixers.mamba_ssm.ops.triton.ssd_combined import (
...
class Mamba2Block(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.mixer = Mamba2(
            dim, use_fast_path=use_fast_path, **config.sequence_mixer.kwargs
        )
        self.mlp = None
