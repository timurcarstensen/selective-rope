...
try:
    ...
    print(
        "git submodule add https://github.com/fla-org/flash-linear-attention.git 3rdparty/flash-linear-attention ln -s 3rdparty/flash-linear-attention/fla fla"
    )
...
class RWKV7Attention(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        print(
            f"RWKV7Attention: hidden_size={hidden_size}, head_dim={self.head_dim}, num_heads={self.num_heads}"
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        kk = l2_norm((k * self.k_k).view(batch_size, seq_len, self.num_heads, -1)).view(
        ...
        o = o + ((r * k * self.r_k).sum(-1, keepdim=True) * v).view(
            batch_size, seq_len, -1
        )
        o = self.o_proj(o * g)
    ...
    def state_size(self, sequence_length: int = 2048):
        return self.num_heads * self.head_dim * self.value_dim
