...
def time_mixer_rwkv5_wrapped_bf16(
    ...
    **kwargs,
    ...
    wkv5_cuda = load(
        ...
        sources=[
            os.path.join(
                base_path, "mad", "model", "layers", "rwkv", "cuda", "wkv5_op.cpp"
            ),
            os.path.join(
                base_path, "mad", "model", "layers", "rwkv", "cuda", "wkv5_cuda.cu"
            ),
        ],
        verbose=True,
        extra_cuda_cflags=[
    ...
    class TimeMixer_RWKV5(MyModule):
            ...
            **kwargs,
            ...
            with torch.no_grad():
                ...
                self.time_decay = nn.Parameter(
                    decay_speed.reshape(self.n_head, self.head_dim)
                )
        ...
        def forward(self, x):
            ...
            x = RUN_CUDA_RWKV5(
                B, T, C, H, r, k, v, w=self.time_decay, u=self.time_faaaa
            )
