...
for l in seqlen_range:
    ...
    mem_usage.append(
        benchmark_memory(linear_attention, q, k, v, qk_normalize=True, causal=True)
    )
...
plt.plot(
    seqlen_range, causal_linear_attn_run_times, "-*", label="Causal Linear Attention"
)
plt.plot(
    seqlen_range,
    causal_sdp_attn_run_times,
...
plt.plot(
    seqlen_range, fast_causal_attn_run_times, "-*", label="Fast Causal Linear Attention"
)
...
plt.figure()
plt.plot(
    seqlen_range, causal_linear_attn_mem_usage, "-*", label="Causal Linear Attention"
)
plt.plot(
    seqlen_range,
    causal_sdp_attn_mem_usage,
...
plt.plot(
    seqlen_range, fast_causal_attn_mem_usage, "-*", label="Fast Causal Linear Attention"
)
plt.xlabel("Sequence Length")
...
for l in seqlen_range:
    ...
    mem_usage.append(
        benchmark_memory(linear_attention, q, k, v, qk_normalize=True, causal=False)
    )
compare = Compare(results)
compare.print()
