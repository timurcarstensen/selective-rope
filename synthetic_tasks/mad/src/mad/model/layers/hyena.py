...
class HyenaOperator(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        assert max_length % num_blocks == 0, (
        ...
        if activation in [None, "id", "identity", "linear"]:
            ...
            raise NotImplementedError(
                f"hidden activation '{activation}' is not implemented"
            )
        ...
        self.long_conv = HyenaConv(
            self.head_dim * (order - 1), max_length, nested=nested, **long_conv_cfg
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.long_conv = MultiHeadHyenaConv(
            self.head_dim * (order - 1), max_length, **long_conv_cfg
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.in_proj = nn.Linear(
            self.dim, (order + 1) * self.dim_inner * self.num_experts
        )
    ...
    def forward(self, u, *args, **kwargs):
        ...
        *x, v = uc.split(self.dim, dim=2)
        ...
        for o, x_i in enumerate(reversed(x[1:])):
            ...
            v = self.long_conv(
                v, l_filter, k=k[o], bias=bias[o, None, :, None], k_rev=None
            )
