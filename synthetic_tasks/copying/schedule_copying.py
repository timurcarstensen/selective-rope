...
def validate_config(cfg: DictConfig, configs_dir: Path) -> None:
    ...
    with warnings.catch_warnings():
        ...
        config = AutoConfig.from_pretrained(str(configs_dir / "model_config.json"))
...
@hydra.main(
    version_base=None,
    config_path=str(Path(git_root) / "configs/copying"),
    config_name="copying",
)
def main(cfg: DictConfig) -> None:
    ...
    # Generate job script
    with open(Path(git_root) / f"configs/copying/{cfg.cluster.filename}") as f:
